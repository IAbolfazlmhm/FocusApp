...
import { setupModalAccessibility, initConfirmModal, closeTopmostModal } from './ui/modal-utils.js';
import { loadSettings, setupSettingsEvents, applySettingsToTimer } from './settings/settings.js';
import { loadTimerState, updatePhaseColors, toggleTimer, setupTimerEvents } from './timer/timer.js';
import { setupTaskEvents } from './tasks/tasks.js';
import { renderFilters, renderTasks } from './tasks/tasks-render.js';
import { setupHabitsEvents, initHabitQuotes } from './habits/habits.js';
import { renderHabits } from './habits/habits-render.js';
import { setupProgressEvents } from './progress/progress.js';
import { playUI } from './ui/audio.js';
import { setupFocusMode, exitFocusMode, isFocusModeActive } from './timer/focus-mode.js';
import { setupQuotesEvents } from './quotes/quotes.js';
import { setupTrashEvents } from './trash/trash-ui.js';
